...
<table align="center" border="1" width="70%">
	...
	<td><input type="date" name="PostDate" value=<?php echo date('Y-m-d');?>> </td>
	</tr>
	<tr>
	<td><div class="labl">Interview Date: </div></td>
	<td><input type="date" name="Interdate" value=<?php echo date('Y-m-d');?>> </td>
	</tr>
	<tr>
	<td><div class="labl">Job Expiry Date: </div></td>
	<td><input type="date" name="expDate" value=<?php echo date('Y-m-d');?>> </td>
	</tr>
	<tr>
